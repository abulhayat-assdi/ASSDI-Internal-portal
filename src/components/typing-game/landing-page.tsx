...
import { Badge, Card, CardContent, SectionHeader, StatCard, WorldCard } from "@/components/typing-game/ui";
    ...
    <div className="flex flex-col gap-16 pb-20 pt-8 md:gap-24">
      ...
      <section className="mx-auto w-full max-w-5xl px-4">
        <div className="flex flex-col items-center gap-4 rounded-xl border border-line bg-raised px-6 py-12 text-center">
          ...
          <Link href={`/register`} className="tap-btn tap-btn-primary tap-btn-lg">
            {t("finalCtaButton")}
          </Link>
        </div>
      </section>
